    ...
    <main className="min-h-screen bg-background pb-20" dir="rtl">
      ...
      <div className="pt-32 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-300 leading-relaxed">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            نحن في "نتفليكس العرب" نحترم خصوصيتك. نحن لا نقوم بجمع أي بيانات شخصية حساسة عن زوارنا. المعلومات الوحيدة التي قد يتم جمعها هي بيانات تقنية عامة مثل نوع المتصفح وعنوان IP لتحسين تجربة التصفح وحمايتها.
          </p>
        </section>
